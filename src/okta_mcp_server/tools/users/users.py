...
async def list_users(
    ...
    try:
        ...
        # Convert users to JSON-serializable dicts
        user_items = serialize_okta_object(users)
        ...
        if fetch_all and response and hasattr(response, "has_next") and response.has_next():
            ...
            all_user_items = serialize_okta_object(all_users)
...
async def get_user(user_id: str, ctx: Context = None) -> list:
    ...
    try:
        ...
        return [serialize_okta_object(user)]
    except Exception as e:
